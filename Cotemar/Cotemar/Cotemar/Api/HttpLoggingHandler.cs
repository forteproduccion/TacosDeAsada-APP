...
namespace Cotemar.Api
{
    ...
    {
        private readonly Func<Task<AuthenticationToken>> getToken;
        public HttpLoggingHandler(Func<Task<AuthenticationToken>> getToken, HttpMessageHandler innerHandler = null) : base(innerHandler ?? new HttpClientHandler())
        {
